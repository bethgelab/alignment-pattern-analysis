...
from multitasking.models._extern.opt_cwm.models.base_cwm import masking_generator, modeling_pretrain
from multitasking.models._extern.opt_cwm.models.flow import occ_predictor, perturber, soft_argmax
from multitasking.models._extern.opt_cwm.utils import constants, dist_logging, utils
...
class FlowPredictor(nn.Module):
    ...
    def load_pretrained(self, highres=False, force=False):
        ...
        ckpt = torch.load(opt_cwm_local_path, map_location="cpu", weights_only=False)["model"]
